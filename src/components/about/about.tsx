...
export default function About() {
  ...
  return (
    <motion.section
      ref={containerRef}
      id="about"
      className="relative min-h-dvh top-0 w-screen bg-cream p-16"
      style={{ rotate, scale }}
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 grid-rows-1 gap-16 w-full">
        <div className="space-y-8 col-span-1">
          <h1 className="text-2xl font-display font-bold text-bg tracking-widest">— WHO WE ARE</h1>
          <h1 className="text-5xl font-condensed font-bold text-bg">We build the spaces between ambition and reality.</h1>

          <p className="font-body text-bg-alt max-w-[60ch]">OA Studios is a Lagos-based architectural practice working at
          ...
          <p className="font-body text-bg-alt max-w-[60ch]">From the first sketch to the final finish, every decision is
            deliberate, every detail considered.
          </p>
